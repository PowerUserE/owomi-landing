  ...
  return (
    ...
    >
      <motion.div
        ...
        className='flex flex-col relative -top-[25%] h-[450px] w-[90%] md:w-[70%] rounded-md p-10 origin-top'
      >
...
const StackingCards = forwardRef<HTMLElement, StackingCardsProps>(({ projects, children }, ref) => {
  const container = useRef(null);
  const { scrollYProgress } = useScroll({
    target: container,
